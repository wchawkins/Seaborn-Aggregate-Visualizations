...
plt.title("Loan Ammounts by Country")
...
plt.title("Loan Ammounts by Country and Sex")
sns.set_palette("Dark2")
sns.set_style("whitegrid")
plt.show()
...
plt.title("Loan Ammount Distributions by Country")
sns.set_palette("Dark2")
sns.set_style("whitegrid")
plt.show()
...
plt.title("Loan Ammounts and Distributions by Country")
sns.set_palette("Dark2")
sns.set_style("whitegrid")
plt.show()
...
plt.title("Loan Ammounts and Distributions by Country and Gender")
sns.set_palette("Dark2")
sns.set_style("whitegrid")
plt.show()
